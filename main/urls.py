...
urlpatterns = [
    ...
    path('api/web/brands/', views.get_brands_api, name='get_web_brands'),
    path('api/web/models/', views.get_models_api, name='get_web_models'),
    path('api/web/variants/', views.get_variants_api, name='get_web_variants'),
    path('api/web/years/', views.get_years_api, name='get_web_years'),
